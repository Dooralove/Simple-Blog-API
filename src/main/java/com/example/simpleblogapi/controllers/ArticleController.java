...
public class ArticleController {
    ...
    @Operation(summary = "Создание статьи",
            description = "Создает новую статью с указанием текущей даты создания.")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Получение статьи", description =
            "Возвращает статью по заданному идентификатору.")
    @ApiResponses(value = {
    ...
    @GetMapping("/{id}")
    public Article getArticleById(@Parameter(in = ParameterIn.PATH, description =
            "Идентификатор статьи", required = true)
    ...
    @Operation(summary = "Получение статей по тегу", description =
            "Возвращает список статей, имеющих заданный тег.")
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Статьи успешно получены"),
    ...
    @GetMapping("/by-tag")
    public List<Article> getArticlesByTagName(@Parameter(in = ParameterIn.QUERY, description =
            "Имя тега", required = true)
                                              @RequestParam String tagName) {
        return articleService.getArticlesByTagName(tagName);
    }

    @Operation(summary = "Удаление статьи", description =
            "Удаляет статью по заданному идентификатору.")
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Статья успешно удалена"),
        @ApiResponse(responseCode = "404", description = "Статья не найдена", content = @Content)
    })
    @DeleteMapping("/{id}")
    public void deleteArticle(@Parameter(in = ParameterIn.PATH, description =
            "Идентификатор статьи", required = true)
                              @PathVariable Long id) {
        articleService.deleteArticle(id);
    }

    @Operation(summary = "Добавление тега к статье", description =
            "Добавляет тег к указанной статье по их идентификаторам.")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Удаление тега из статьи", description =
            "Удаляет тег из указанной статьи по их идентификаторам.")
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description =
                "Тег успешно удален из статьи"),
        @ApiResponse(responseCode = "404", description =
                "Статья или тег не найдены", content = @Content)
    })
    ...
    @Operation(summary = "Лайк статьи", description =
            "Добавляет лайк к статье по её идентификатору.")
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Лайк успешно добавлен"),
        @ApiResponse(responseCode = "404", description = "Статья не найдена", content = @Content)
    })
    @PostMapping("/{id}/like")
    public Article likeArticle(@Parameter(in = ParameterIn.PATH, description =
            "Идентификатор статьи", required = true)
                               @PathVariable Long id) {
        return articleService.likeArticle(id);
    }

    @Operation(summary = "Дизлайк статьи", description =
            "Добавляет дизлайк к статье по её идентификатору.")
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Дизлайк успешно добавлен"),
        @ApiResponse(responseCode = "404", description = "Статья не найдена", content = @Content)
    })
    @PostMapping("/{id}/dislike")
    public Article dislikeArticle(@Parameter(in = ParameterIn.PATH, description =
            "Идентификатор статьи", required = true)
                                  @PathVariable Long id) {
        return articleService.dislikeArticle(id);
    }

    @Operation(summary = "Удаление лайка", description =
            "Удаляет лайк у статьи по её идентификатору.")
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Лайк успешно удален"),
        @ApiResponse(responseCode = "404", description = "Статья не найдена", content = @Content)
    })
    @DeleteMapping("/{id}/like")
    public Article removeLike(@Parameter(in = ParameterIn.PATH, description =
            "Идентификатор статьи", required = true)
                              @PathVariable Long id) {
        return articleService.removeLike(id);
    }

    @Operation(summary = "Удаление дизлайка", description =
            "Удаляет дизлайк у статьи по её идентификатору.")
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Дизлайк успешно удален"),
        @ApiResponse(responseCode = "404", description = "Статья не найдена", content = @Content)
    })
    @DeleteMapping("/{id}/dislike")
    public Article removeDislike(@Parameter(in = ParameterIn.PATH, description =
            "Идентификатор статьи", required = true)
                                 @PathVariable Long id) {
